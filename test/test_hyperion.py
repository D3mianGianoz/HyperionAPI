...
def test_hyperion_tcp_comm():
    response = hyperion.HCommTCPClient.hyperion_command(
        instrument_ip, "#GetSerialNumber"
    )
...
def test_hyperion_properties():
    ...
    test_static_net_settings = hyperion.NetworkSettings(
        "10.0.0.55", "255.255.0.0", "10.0.0.1"
    )
